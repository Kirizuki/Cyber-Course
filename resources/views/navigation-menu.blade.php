            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    ...
                    @if(Auth::user()->is_admin)
                        <a href="{{ route('admin.dashboard') }}" class="-m-1.5 p-1.5 font-bold text-2xl text-[#E0D6ED] hover:text-indigo-600">
                            Cyber Course
                        </a>
                    <!-- user -->
                    @else
                        <a href="{{ route('forum') }}" class="-m-1.5 p-1.5 font-bold text-2xl text-[#E0D6ED] hover:text-indigo-600">
                            Cyber Course
                        </a>
                    @endif
                 </div>
                    ...
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button class="flex text-sm  border-transparent rounded-full focus:outline-none focus:border-gray-300 transition items-center gap-3">
                                    <h1 class="text-lg font-sans text-white">{{ Auth::user()->name }}</h1>
