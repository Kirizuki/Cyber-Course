    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-center">
                <h1 class="text-5xl font-black text-[#E0D6ED]">
            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-xl sm:rounded-lg mt-10">
                <div class="flex flex-row gap-x-96 items-center px-16 py-10">
                    <h2 class="text-[#E0D6ED] font-bold text-3xl">
                        Forum Report Count :
                    </h2>
                    <div class="flex flex-col items-center gap-5">
                        <h3 class="text-[#E0D6ED] text-5xl">
                            {{ $reportCount }}
                        </h3>
                        <h3 class="text-[#E0D6ED] text-3xl ">
                            Reports
                        </h3>
                    </div>
                </div>
