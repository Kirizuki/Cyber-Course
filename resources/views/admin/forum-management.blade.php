<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-[#E0D6ED] dark:text-gray-200 leading-tight">
    ...
    <div class="py-12">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if($forums->count() == 0)
                <h1 class="text-base text-gray-400 mt-10">No reported course, have a good day!</h1>
            @endif
