...
Route::middleware([
    ...
    Route::middleware([CheckIfAdmin::class])->prefix('admin')->group(function () {
        ...
        Route::get('/course-management', [ForumManagementControler::class, 'index'])->name('forum-management');
    ...
    Route::prefix('course')->group(function () {
        ...
        Route::post('/course/{forumId}/remove-image', [EditForumController::class, 'removeImage'])->name('forum.remove-image');
